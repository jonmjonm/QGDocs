...
- **[Cycle Walk](cycleWalk.qmd):** A Julia implementation of a promising algorithm to sample an ensemble of redistricting maps from a specified measure on the space of all redistrictings. The algorithm is described in [@deford2025cyclewalksamplingmeasures].
- **[Metropolized Forest Recom](forest_recom.qmd):** An algorithm that modifies the original Recom algorithm [@deford2019recombination]  so that it can better sample from a specified probability distribution. and so that it can better preserve geographical structure like counties. [See @autry2023metropolized]
