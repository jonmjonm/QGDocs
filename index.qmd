...
- **[Metropolized Forest RECOM](forest_recom.qmd):** An algorithm that modifies the original RECOM algorithm so that it can better sample from a specified probability distribution and so that it can better preserve geographical structure like counties. 
